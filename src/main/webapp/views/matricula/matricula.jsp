                    ...
                    <tbody>
                        <c:forEach var="m" items="${matriculas}" varStatus="s">
                            <tr class="text-center">
                                ...
                                <td>${m.seccion}</td>
                                <td>
                                    <span class="badge bg-${m.estado == 'regular' ? 'bg-success' :
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="${pageContext.request.contextPath}/matricula?action=ver&id=${m.idMatricula}" class="btn btn-sm btn-outline-primary" title="Ver detalle">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="${pageContext.request.contextPath}/matricula?action=editar&id=${m.idMatricula}" class="btn btn-sm btn-outline-warning" title="Editar matrícula">
...
<script>
    ...
    function filtrarPorAnio() {
        ...
        window.location.href = `${ctx}/matricula?anio=${anio}`;
    }
